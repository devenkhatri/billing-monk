...
const config: Config = {
  ...
  url: 'https://your-invoice-ninja-clone.example.com',
  ...
  projectName: 'invoice-ninja-clone', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/your-org/invoice-ninja-clone',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: 'Admin Guide',
              to: '/docs/admin-guide/installation',
            },
            {
